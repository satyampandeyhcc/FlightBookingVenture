...
const url =
  "mongodb+srv://satyampandeyhcc:satyam123@cluster0.iukbirw.mongodb.net/ticketbookingsystem?retryWrites=true&w=majority";
...
const passengerDetailsSchema = Schema({
  ...
  age: {
    type: Number,
    min: [1, "Passengers below 1 year are not allowed"],
    max: [70, "Passengers above 70 years are not allowed"],
  },
});
